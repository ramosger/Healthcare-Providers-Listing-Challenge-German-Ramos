...
export const Header = () => {
  return (
    <header className="fixed top-0 left-0 w-96 lg:w-full p-6 lg:px-44 lg:py-6 bg-white border-b border-(--border-default) inline-flex justify-between items-center">
